...
pub fn create_delegate_class() {
  ...
  extern "C" fn configuration_for_connecting_scene_session(
    ...
    unsafe {
      ...
      // Hand the configuration to the autorelease pool instead of dropping it
      // here: UIKit retains it after this returns, and a release build had
      // already freed it by then (upstream pull request 1245).
